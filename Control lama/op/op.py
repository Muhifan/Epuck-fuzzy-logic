...
TIME_STEP = 64
MAX_SPEED = 6.28from controller import Robot, DistanceSensor, Motor
import numpy as np
import skfuzzy as fuzz
from skfuzzy import control as ctrl
...
while robot.step(TIME_STEP) != -1:
    ...
    print("Pembacaan sensor PS0 (sebelah kiri):", jarak_kiri_value)
    print("Pembacaan sensor PS7 (sebelah kanan):", jarak_kanan_value)
