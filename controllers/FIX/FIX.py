...
while robot.step(TIME_STEP) != -1:
    ...
    jarak_kanan_value = ps9.getValue()
    jarak_kiri_value = ps11.getValue()
    ...
    # elif jarak_kanan_value < 400:   # Jika ada objek di sebelah kanan (PS11 membaca < 1.0)
    #     left_motor.setVelocity(MAX_SPEED)
    #     right_motor.setVelocity(-MAX_SPEED)
    # elif jarak_kiri_value < 400:    # Jika ada objek di sebelah kiri (PS9 membaca < 1.0)
    #     left_motor.setVelocity(-MAX_SPEED)
    #     right_motor.setVelocity(MAX_SPEED)
