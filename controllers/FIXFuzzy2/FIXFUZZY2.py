...
while robot.step(TIME_STEP) != -1:
    ...
    Persentase_lambat_kanan = np.fmin(np.fmax(rules_2, np.fmax(rules_3, np.fmax(rules_10, np.fmax(rules_11, np.fmax(rules_12, np.fmax(rules_20, rules_21)))))), lambat_kanan)
    Persentase_normal_kanan = np.fmin(np.fmax(rules_4, np.fmax(rules_5, np.fmax(rules_6, np.fmax(rules_7, np.fmax(rules_8, np.fmax(rules_14, np.fmax(rules_15, np.fmax(rules_17, np.fmax(rules_18, np.fmax(rules_23, rules_24)))))))))), normal_kanan)
    ...
    Persentase_lambat_kiri = np.fmin(np.fmax(rules_4, np.fmax(rules_7, np.fmax(rules_10, np.fmax(rules_11, np.fmax(rules_12, np.fmax(rules_16, np.fmax(rules_19, np.fmax(rules_20, np.fmax(rules_21, rules_22))))))))), lambat_kiri)
    Persentase_normal_kiri = np.fmin(np.fmax(rules_13, np.fmax(rules_14, np.fmax(rules_15, np.fmax(rules_17, np.fmax(rules_18, np.fmax(rules_23, np.fmax(rules_24, rules_26))))))), normal_kiri)
    ...
    if sensor_depan_tengah < 350:   # Jika ada objek di sebelah kanan (PS11 membaca < 1.0)
